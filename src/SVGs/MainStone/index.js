  ...
  return(
    <div className='svg-container2'>
	    ...
	    viewBox="0 0 1920 1080" width='30%' height='30%' ref={el=>mystone=el}>
            ...
            <polygon ref={el=>mystone2=el} fill="none" stroke="rgba(214, 214, 214, 1)" stroke-width="50" stroke-miterlimit="10" points="1002.5,85 653.8,689 1351.2,689 "/>
            <rect ref={el=>mystone3=el} x="851.5" y="387" stroke="rgba(214, 214, 214, 1)" fill="none" stroke-width="50" stroke-miterlimit="10" width="302" height="302"/>
            <circle ref={el=>mystone4=el} fill="none" stroke='url(#linear2)' stroke-width="50" stroke-miterlimit="10" cx="1002.5" cy="537.5" r="120"/>
            <circle ref={el=>mystone1=el} fill="none"  stroke='rgba(214, 214, 214, 1)' stroke-width="50" stroke-miterlimit="10" cx="1002.5" cy="493.5" r="435.5"/>
        </svg>
    </div>
   )

...
export default class Product0 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            title: 'string',
    ...
    handleSubmit(event) {
        const order = {
            label: '00001',
            line_items: [{
                product_id: "6108bcef3bf01c378b0519aa",
    ...
    componentDidMount() {
        instance.get('https://api.printify.com/v1/shops/3270327/products/6108bcef3bf01c378b0519aa.json')
          .then(res => {
            const prod = res.data;
            const variant_id = [];
            const variant_title = [];
